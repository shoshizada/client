    ...
    return  (
            <div>
                ...
                <Stack spacing={3}>
                    ...
                    <Input onChange={(e) => newLocation.location_geolocation.lat= e.target.value}  name="lat" placeholder='lat' size='md' isInvalid errorBorderColor='red.300' _placeholder={{ opacity: 0.4, color: 'orange' }}  ></Input>
                    <Input  onChange={(e) => newLocation.location_geolocation.lng= e.target.value}  name="lng" placeholder='lng' size='md' isInvalid errorBorderColor='red.300' _placeholder={{ opacity: 0.4, color: 'orange' }}  ></Input>
                    ...
                    <InputGroup>
                        ...
                        />
                        <Input onChange={(e) => newLocation.communication_details.phone= e.target.value} name="phone" type='tel' placeholder='Phone number'></Input>
                    </InputGroup>
                    <Input  onChange={(e) => newLocation.communication_details.email= e.target.value}  name="email" placeholder='email' size='md' isInvalid errorBorderColor='red.300' _placeholder={{ opacity: 0.4, color: 'orange' }}  ></Input>
